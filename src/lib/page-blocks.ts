...
export const BLOCK_TYPES = {
  ...
  cta_banner: {
    ...
    defaultProps: {
      ...
      backgroundColor: "", headingColor: "#ffffff",
  ...
  contact_form: {
    ...
    defaultProps: {
      ...
      backgroundColor: "#f8fafc", buttonColor: "",
  ...
  newsletter_signup: {
    ...
    defaultProps: {
      ...
      buttonColor: "", buttonTextColor: "#ffffff",
    },
  },
  quote: {
    label: "Quote",
  ...
  philosophy: {
    ...
    defaultProps: {
      ...
      pillarNameColor: "", pillarNameFont: "",
