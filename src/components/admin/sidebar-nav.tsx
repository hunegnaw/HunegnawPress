    ...
    <nav className="flex-1 px-4">
      ...
      <ul className="space-y-0.5 mb-6">
        <li>
          ...
          >
            <span className={`w-1.5 h-1.5 rounded-full ${pathname === "/admin" ? "bg-blue-500" : "bg-current opacity-60"}`} />
            Dashboard
          </Link>
        </li>
      </ul>
            ...
            <li key={item.href}>
              ...
              >
                <span className="flex items-center gap-3">
                  <span className={`w-1.5 h-1.5 rounded-full ${active ? "bg-blue-500" : "bg-current opacity-60"}`} />
                  {item.label}
                </span>
                {count !== undefined && (
