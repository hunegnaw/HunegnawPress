    ...
    <div>
      ...
      <div className="flex gap-2">
        <select
          ...
          className="flex-1 px-3 py-1.5 text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600/50"
        >
        ...
        <input
          ...
          placeholder="Size"
          className="w-28 px-3 py-1.5 text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600/50"
        />
      </div>
      {hint && (
