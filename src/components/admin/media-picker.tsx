...
export function MediaPicker({
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
    >
      <div className={`bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[80vh] flex flex-col relative ${dragging ? "ring-4 ring-blue-600 ring-opacity-50" : ""}`}>
        {dragging && (
          <div className="absolute inset-0 bg-blue-600/10 rounded-xl z-10 flex items-center justify-center pointer-events-none">
          ...
          {tab === "browse" && (
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-1.5 text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600/50"
              />
            </div>
          )}
        </div>
                ...
                {media.map((item) => (
                  <div key={item.id} className="group relative">
                    <button
                      ...
                      className="w-full aspect-square rounded-lg overflow-hidden border-2 border-transparent hover:border-blue-600 transition-colors bg-gray-100"
                    >
