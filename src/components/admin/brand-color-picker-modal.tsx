      ...
      <DialogContent className="sm:max-w-2xl max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600/50"
          />
        </div>
        ...
        <div className="border-t pt-3 mt-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              placeholder="#000000"
              className="flex-1 px-3 py-1.5 text-sm font-mono border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600/50"
            />
            <button
              type="button"
              onClick={() => {
