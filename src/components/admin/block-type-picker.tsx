            ...
            ([type, config]) => {
              ...
              return (
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-4 rounded-lg border border-gray-200 hover:border-blue-600 hover:bg-slate-50 transition-colors text-center"
                >
                  <Icon size={24} />
