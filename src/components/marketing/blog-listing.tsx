            ...
            {posts.map((post) => (
              ...
              >
                {post.heroImageUrl ? (
                  ...
                  <div className="aspect-[16/10] bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center">
                ...
                <div className="p-5">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {post.categories.map((pc: { category: { id: string; name: string; color: string | null } }) => (
                        <span
                          ...
                          style={{
                            backgroundColor: (pc.category.color || "#2563eb") + "20",
                            color: pc.category.color || "#2563eb",
                          }}
                        >
                          {pc.category.name}
                        </span>
                  ...
                  <h2
                    ...
                    style={{
                      ...
                      color: "var(--font-blog-card-title-color, #1e293b)",
                    }}
                  >
                    {post.title}
                  </h2>
