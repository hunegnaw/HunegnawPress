...
export function FaqBlock({ props }: FaqBlockProps) {
  ...
  const questionColor = (props.questionColor as string) || "#1e293b";
  const answerColor = (props.answerColor as string) || "#64748b";
  const sectionTitleColor = (props.sectionTitleColor as string) || "#1e293b";
                  ...
                  >
                    ...
                    >
                      <span
                        ...
                        style={{
                          fontFamily:
                            "var(--font-section-heading-family, 'Inter'), sans-serif",
                          fontSize: "14px",
                          fontWeight: 400,
