...
const ACTION_TYPES = [
  ...
  { value: "REORDER_PAGES", label: "Reorder Pages" },
  ...
  { value: "CREATE_BLOG_CATEGORY", label: "Create Blog Category" },
  { value: "UPDATE_BLOG_CATEGORY", label: "Update Blog Category" },
  { value: "DELETE_BLOG_CATEGORY", label: "Delete Blog Category" },
  { value: "UPLOAD_MEDIA", label: "Upload Media" },
  { value: "RENAME_MEDIA", label: "Rename Media" },
