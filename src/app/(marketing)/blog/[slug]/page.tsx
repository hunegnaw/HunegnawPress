  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <article className="max-w-4xl mx-auto px-6 pb-16">
        <div
          className="prose prose-lg max-w-none prose-headings:text-slate-800 prose-a:text-blue-600 prose-strong:text-slate-800"
              ...
              {relatedPosts.map((rp) => (
                ...
                >
                  {rp.heroImageUrl ? (
                    ...
                    <div className="aspect-[16/10] rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center mb-3">
